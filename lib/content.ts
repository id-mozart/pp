...
export const clients = {
  ...
  // Client logos shown as a clean monochrome grid, no cards (placeholders —
  // swap the files in /public/brand/logos for the real client logos later).
  logoTiles: [
    { name: "Coca-Cola", src: "/brand/logos/cocacola.svg" },
    { name: "PepsiCo", src: "/brand/logos/pepsi.svg" },
    { name: "McDonald's", src: "/brand/logos/mcdonalds.svg" },
    { name: "Visa", src: "/brand/logos/visa.svg" },
    { name: "Mastercard", src: "/brand/logos/mastercard.svg" },
    { name: "Samsung", src: "/brand/logos/samsung.svg" },
    { name: "Huawei", src: "/brand/logos/huawei.svg" },
    { name: "IBM", src: "/brand/logos/ibm.svg" },
    { name: "Intel", src: "/brand/logos/intel.svg" },
    { name: "SAP", src: "/brand/logos/sap.svg" },
    { name: "Oracle", src: "/brand/logos/oracle.svg" },
    { name: "Cisco", src: "/brand/logos/cisco.svg" },
    { name: "Siemens", src: "/brand/logos/siemens.svg" },
    { name: "Bosch", src: "/brand/logos/bosch.svg" },
    { name: "ABB", src: "/brand/logos/abb.svg" },
    { name: "Schneider Electric", src: "/brand/logos/schneiderelectric.svg" },
    { name: "General Electric", src: "/brand/logos/generalelectric.svg" },
    { name: "Caterpillar", src: "/brand/logos/caterpillar.svg" },
    { name: "3M", src: "/brand/logos/3m.svg" },
    { name: "Accenture", src: "/brand/logos/accenture.svg" },
    { name: "DHL", src: "/brand/logos/dhl.svg" },
    { name: "Airbus", src: "/brand/logos/airbus.svg" },
    { name: "Mercedes-Benz", src: "/brand/logos/mercedes.svg" },
    { name: "BMW", src: "/brand/logos/bmw.svg" },
  ],
  stats: [
