...
export const courses = {
  hero: {
    ...
    items: [
      { n: "01", title: "Продажі та переговори", sub: "Онлайн-курси", image: "/brand/courses/bubbles.jpg" },
      { n: "02", title: "Чек-листи для продажів", sub: "Готові до впровадження", image: "/brand/courses/checklist.jpg" },
      { n: "03", title: "Скрипти повідомлень", sub: "Для нових клієнтів", image: "/brand/courses/scripts.jpg" },
    ],
