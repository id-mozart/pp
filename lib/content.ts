...
export const requests = {
  ...
  title: "Пʼять запитів, з яких усе починається",
  intro:
    "Впізнали щось своє? Натисніть на свій пункт — і поговорімо, як ми розвʼязуємо це разом.",
  items: [
    "Низькі продажі",
    "Нестабільні продажі",
  ...
  cards: [
    {
      ...
      summary: "Тренінг під ваш запит — не з полиці, а на ваших реальних кейсах.",
    ...
    },
    {
      number: "02",
      title: "Онлайн-курси",
      summary: "Готові курси з продажів — починаєте застосовувати вже сьогодні.",
