...
export const CONCEPTS: Concept[] = [
  {
    ...
    numeral: "M5",
    name: "Main 5 · година",
    tagline: "Авторська · сторінка-сесія 60 хвилин",
  ...
  },
  {
    ...
    numeral: "M3",
    name: "Main 3 · лист",
    tagline: "M2 + лого-плитка · менторинг-лист",
    swatch: { canvas: "#090908", gold: "#E2A638", ink: "#F4E6CC" },
  },
  {
    id: "main4",
    numeral: "M4",
    name: "Main 4 · розмова",
    tagline: "M2 + лого-плитка · менторинг-діалог",
    swatch: { canvas: "#090908", gold: "#E2A638", ink: "#F4E6CC" },
  },
  {
    id: "main2",
    numeral: "M2",
    name: "Main 2",
    tagline: "Робоча версія · аудит AD+CRO",
    swatch: { canvas: "#090908", gold: "#E2A638", ink: "#F4E6CC" },
  },
  {
    id: "main",
...
export const DEFAULT_CONCEPT: ConceptId = "main5";
