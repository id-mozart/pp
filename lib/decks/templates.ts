...
export const PAGE_TEMPLATES: PageTemplate[] = [
  ...
  tpl("cover-amp", "Титул і розділи", "Титул · амперсанд", "Без фото: великий амперсанд з логотипа праворуч",
    () => ({ type: "cover", eyebrow: "Тренінг", title: "Назва програми:", titleEm: "підзаголовок курсивом", sub: "", who: "Бізнес-тренерка Тетяна Пан", when: "Україна, 2026", variant: "amp", avatar: T + "tania-profile.jpg" })),
