...
const FAQ = [
  {
    ...
    a: (
      <>
        З онлайн-консультації 1:1. Одна фокусна година — і ви знаєте вузьке
        місце своїх продажів, маєте план наступних кроків і конкретні скрипти.{" "}
        <Link href="/consultation#book" className="text-gold lux-link">
          Забронювати годину →
        </Link>
      </>
    ),
  },
  {
    ...
    a: (
      <>
        Корпоративні тренінги під ваш запит (
        <Link href="/b2b" className="text-gold lux-link">
          B2B
        </Link>
        ), готові{" "}
        <Link href="/courses" className="text-gold lux-link">
          онлайн-курси
        </Link>{" "}
        та наставництво — командне чи індивідуальне, у групах до 4 осіб. Онлайн
        або офлайн — як зручніше вам.
      </>
    ),
  },
  {
...
function MainV3({ mentoring }: { mentoring: "letter" | "dialog" }) {
    ...
    <>
          ...
          <Reveal className="flex flex-col gap-7 lg:col-span-6 lg:col-start-7">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/consultation#book" className="btn btn-primary">
                Записатися на консультацію <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="#formats" className="btn btn-ghost">
                Формати роботи
              </Link>
            </div>
            <p className="font-mono text-[0.65rem] uppercase tracking-[0.18em] text-ink/60">
              Онлайн 1:1 · 60 хвилин · план дій і скрипти
            </p>
      ...
      <section id="mentoring" className="relative grain section-pad">
        <div className="container-shell grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          {mentoring === "letter" ? <MentoringLetter /> : <MentoringDialog />}
        </div>
      </section>
...
/* ---------- Менторинг · варіант «Лист від Тетяни» ---------- */
function MentoringLetter() {
  return (
      ...
      <Reveal delay={0.06} className="mt-7">
        <figure className="relative max-w-2xl pl-7">
          <span
            ...
            style={{ background: GRAD_GOLD }}
          />
          <div className="flex flex-col gap-5 text-pretty font-display text-[1.15rem] italic leading-relaxed text-ink/90">
            <p>
              Якщо ціну ваших послуг досі захищаєте тільки ви. Якщо найважливіші
              переговори нікому не передати. Якщо хочеться впевненості, а не ще
              одного «тренінгу для галочки» — цей формат для вас.
            </p>
            <p>
              Працюємо віч-на-віч або в групі до чотирьох. Беремо ваші реальні
              угоди й розбираємо їх до рішення — у вашому темпі. Між зустрічами
              ви не залишаєтеся наодинці з питаннями: я поруч.
            </p>
            <p>
              Це найближчий формат роботи зі мною — і найкоротший шлях від
              «знаю, як треба» до «роблю, і це працює».
            </p>
          </div>
          <figcaption className="mt-6 flex items-end gap-4">
            <span
            ...
            <span className="pb-1 font-mono text-[0.62rem] uppercase tracking-[0.22em] text-faint">
              засновниця Pan&Partners
            </span>
          </figcaption>
        </figure>
      </Reveal>

      <Reveal delay={0.1} className="mt-9 flex flex-col gap-5">
        <span
        ...
        <div className="flex flex-wrap items-center gap-x-7 gap-y-3">
          <Link href="/consultation#book" className="btn btn-primary">
            Почати з консультації 1:1 <ArrowRight className="h-4 w-4" />
          </Link>
          <a
            href="#contact"
...
/* ---------- Менторинг · варіант «Розмова один на один» ---------- */
const DIALOG = [
  {
    q: "У мене всі ключові угоди тримаються на мені. Це нормально?",
    a: "Поки бізнес малий — так. Далі це стеля. На менторингу будуємо структуру продажів, яка працює й без вашої участі в кожній угоді.",
  },
  {
    q: "Клієнти тиснуть на знижки. Що робити з ціною?",
    a: "Ціна — це переговори, а не цифра у прайсі. Беремо ваші реальні кейси й тренуємо, як захищати вартість — без тиску й маніпуляцій.",
  },
  {
    q: "А якщо у мене специфічна ніша?",
    a: "Жодних шаблонів: методологію збираємо під ваш бізнес. За плечима — 25+ років практики у 6 галузях, від FMCG до B2B-послуг.",
  },
  {
    q: "З чого почати?",
    a: "З консультації 1:1. На ній визначаємо формат і програму — далі рухаємось у вашому темпі, з підтримкою між зустрічами.",
  },
];
  ...
  return (
    <div className="lg:order-1 lg:col-span-7">
      <Reveal className="flex flex-col gap-4">
        ...
        <p className="max-w-xl text-pretty text-lg leading-relaxed text-muted">
          Чотири питання, які нам ставлять найчастіше, — і чесні відповіді
          Тетяни.
        </p>
      </Reveal>
      ...
      <RevealGroup className="mt-8 flex flex-col">
        {DIALOG.map((d) => (
          <RevealItem key={d.q}>
            <div className="border-t border-line/50 py-6 last:border-b">
              <p className="font-mono text-[0.62rem] font-medium uppercase tracking-[0.22em] text-faint">
                Ви запитуєте
              </p>
              <p className="mt-2 max-w-xl font-display text-xl italic leading-snug text-ink">
                «{d.q}»
              </p>
              <div className="mt-4 flex items-start gap-3">
                ...
                <img
                  src="/brand/Tania4.webp"
                  alt="Тетяна Пан"
                  className="h-9 w-9 shrink-0 rounded-full border border-gold/30 object-cover object-top"
                  style={{ background: CARD_BG }}
                  loading="lazy"
                />
                <div>
                  <p
                    className="font-mono text-[0.62rem] font-medium uppercase tracking-[0.22em]"
                    style={gradText(GRAD_ACC)}
                  >
                    Тетяна відповідає
                  </p>
      ...
      <Reveal delay={0.1} className="mt-9 flex flex-wrap items-center gap-x-7 gap-y-3">
        <span
          className="inline-flex w-fit items-center gap-2 rounded-[10px] border border-line/70 px-3.5 py-2 font-mono text-[0.62rem] font-medium uppercase tracking-[0.1em] text-ink"
          style={{ background: CTAG_BG, borderLeft: "3px solid #E2A638" }}
        >
...
export function Main3Home() {
  return <MainV3 mentoring="letter" />;
}

export function Main4Home() {
  return <MainV3 mentoring="dialog" />;
}
